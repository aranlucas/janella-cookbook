        ...
        <div className="container max-w-3xl">
          ...
          <div className="prose prose-stone dark:prose-invert max-w-none">
            ...
            <p className="text-muted-foreground mt-4">
              ...
              explains how we collect, use, and act on your personal information
            ...
            <p className="text-muted-foreground mt-4">
              We do not currently collect personal data or use cookies for
              tracking purposes. This is a personal project used for educational
              and private use.
            </p>
